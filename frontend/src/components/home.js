    ...
    >
      <Container maxWidth="md" sx={{ textAlign: 'center' }}>
        ...
        <Typography variant="h6" sx={{ mb: 2, textDecoration: 'underline' }}>
          What can LogicAI Tutor do for you?
        </Typography>
        <Typography variant="body1" sx={{ mb: 1 }}>
          - Answer questions related to Science, Math, Technology, and Education.
        </Typography>
        <Typography variant="body1" sx={{ mb: 1 }}>
        ...
        <Typography variant="h6" sx={{ mt: 4, fontWeight: 'bold' }}>
          Get started now and enhance your learning experience with LogicAI Tutor !
        </Typography>
      </Container>
    </Box>
  );
