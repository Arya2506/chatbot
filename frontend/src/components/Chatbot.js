...
const Chatbot = () => {
  ...
  const [subjects] = useState(["Math", "Science", "Technology", "Education"]); // Available subjects
  ...
  const handleVoiceSubmit = async () => {
    if (!transcript.trim() || !subject) return;
  ...
  return (
    ...
    >
      <Box sx={{ width: "100%", maxWidth: 600, mx: "auto", p: 3, boxShadow: 3, borderRadius: 2, backgroundColor: "#F0F8FF" }}>
        <Typography variant="h5" align="center">LogicAI</Typography>
